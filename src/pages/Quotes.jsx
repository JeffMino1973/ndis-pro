...
export default function Quotes() {
  ...
  const [form, setForm] = useState({
    ...
    status: "Draft",
    notes: "",
    line_items: [{ description: "", support_item_code: "", hours: 1, rate: 61.16, amount: 61.16 }],
  });
  ...
  const addLine = () => {
    setForm((prev) => ({
      ...prev,
      line_items: [...prev.line_items, { description: "", support_item_code: "", hours: 1, rate: 61.16, amount: 61.16 }],
    }));
  };
