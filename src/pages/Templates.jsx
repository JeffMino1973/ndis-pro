...
const TEMPLATES = [
  ...
  },
  {
    id: "service_agreement",
    label: "Service Agreement",
    description: "NDIS service agreement with schedule of supports, costing, responsibilities and signature section",
    icon: FileText,
    color: "bg-indigo-50 text-indigo-700 border-indigo-200",
    isLocal: true,
    localPath: "/service_agreement.html",
  ...
  },
  {
    id: "support_plan",
    label: "Support Plan",
    description: "Full capacity building support plan — travel, domestic living, community, shopping, digital literacy and endorsements",
    icon: ScrollText,
    color: "bg-teal-50 text-teal-700 border-teal-200",
    isLocal: true,
    localPath: "/support_plan.html",
  },
  {
    id: "epilepsy_plan",
