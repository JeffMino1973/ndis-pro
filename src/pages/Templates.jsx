...
const TEMPLATES = [
  ...
  },
  {
    id: "support_plan",
    label: "Support Plan",
    description: "Full NDIS support plan with journey overview, skill development table, domestic living, community access, shopping program, digital literacy and endorsements",
    icon: FileText,
    color: "bg-cyan-50 text-cyan-700 border-cyan-200",
    isLocal: true,
