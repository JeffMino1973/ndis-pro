...
const TEMPLATES = [
  ...
  {
    id: "travel_risk_assessment",
    label: "Travel Risk Assessment",
    description: "NDIS travel risk assessment with likelihood matrix, hazard control table, emergency contacts and assessor sign-off",
    icon: FileText,
    color: "bg-red-50 text-red-700 border-red-200",
    isLocal: true,
    localPath: "/travel_risk_assessment.html",
  },
  {
    id: "travel_itinerary_botany",
    label: "Travel Itinerary – Coogee to Botany",
    description: "Step-by-step bus travel itinerary with outbound and return journeys, stop IDs, transfer walks and arrival times",
    icon: FileText,
    color: "bg-cyan-50 text-cyan-700 border-cyan-200",
    isLocal: true,
    localPath: "/travel_itinerary_coogee_botany.html",
  },
  {
    id: "travel_itinerary_randwick",
    label: "Travel Itinerary – Coogee to Randwick",
    description: "Bus 370 itinerary with outbound and return journeys, all stops listed and estimated 10 minute travel time",
    icon: FileText,
    color: "bg-violet-50 text-violet-700 border-violet-200",
    isLocal: true,
    localPath: "/travel_itinerary_coogee_randwick.html",
  },
  {
    id: "goal_setting",
  ...
  },
  {
    ...
    label: "Behavioural Support Strategy",
    description: "Full PBS framework with clinical formulation, crisis phases, tactical toolbox, scripts, emergency contacts and ABC log",
    icon: FileText,
    color: "bg-purple-50 text-purple-700 border-purple-200",
    isLocal: true,
    localPath: "/behaviour_support_plan.html",
  },
  {
  ...
  },
  {
    ...
    color: "bg-red-50 text-red-700 border-red-200",
    isLocal: true,
    localPath: "/crisis_management_plan.html",
  },
  {
    id: "crisis_plan_p2",
    label: "Crisis Management & Safety Plan — Page 2",
    description: "Emergency directory, immediate crisis protocol, support services and NDIS safeguarding steps",
    icon: ScrollText,
    color: "bg-red-50 text-red-700 border-red-200",
    isLocal: true,
    localPath: "/crisis_management_plan_p2.html",
  },
  {
