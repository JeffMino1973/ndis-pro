      ...
      <nav className="sticky top-0 z-50 bg-slate-800 shadow-lg">
        <div className="max-w-6xl mx-auto px-6 py-3.5 flex items-center gap-4 flex-wrap">
          ...
          <div className="flex gap-2 flex-wrap">
            <a href="mailto:jeff@szjiesupportservices.com" className="text-white text-xs font-bold px-3 py-2 rounded-lg hover:bg-slate-700 transition">
              Contact Us
            </a>
        ...
        <div className="max-w-6xl mx-auto px-6 flex items-stretch" style={{ minHeight: 360 }}>
          <div className="flex flex-col justify-center py-16 pr-12 flex-1 z-10">
            ...
            <div className="flex gap-3 mt-4">
              <a href="tel:0401343876" className="flex items-center gap-2 bg-white text-slate-800 hover:bg-slate-100 font-bold text-sm px-5 py-2.5 rounded-lg transition">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="text-3xl font-black text-slate-800 mb-5">Who We Are</h2>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Empowerment", "Capacity Building", "Integrity", "Inclusion", "Dignity", "Evidence-Based Support"].map((v, i) => (
                    <span key={i} className="text-xs font-bold bg-slate-800 text-white px-3 py-1.5 rounded-full">{v}</span>
                  ))}
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-slate-50 border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-slate-800 mb-4">Core Services</h2>
            ...
            {[
              ...
              return (
                <div key={i} className="bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                  ...
                  <h3 className="font-black text-slate-800 text-sm mb-2">{s.title}</h3>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl font-black text-slate-800 mb-5">Specialised Travel Training</h2>
              <p className="text-slate-600 text-sm leading-relaxed mb-4">
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-slate-800 mb-3">Meet Our Team</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              <div className="bg-slate-800 p-8 flex flex-col items-center text-center">
                <img
              ...
              <div className="p-7">
                ...
                <div className="flex gap-2">
                  <a href="/dashboard/toby" className="flex-1 text-center bg-slate-800 hover:bg-slate-800 text-white font-bold py-2.5 rounded-xl text-xs transition">
                    View Full Profile
                  </a>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              ...
              <div className="p-7">
                ...
                <div className="flex gap-2">
                  <a href="/dashboard/jeffrey" className="flex-1 text-center bg-slate-800 hover:bg-slate-800 text-white font-bold py-2.5 rounded-xl text-xs transition">
                    View Full Profile
                  </a>
      ...
      <section className="py-20 bg-white border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-slate-800 mb-4">Technology Designed Around People</h2>
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 mb-10">
            {APP_SOLUTIONS.map((app, i) => (
              <div key={i} className={`rounded-2xl border p-6 ${app.color} hover:shadow-md transition-all`}>
                ...
                <h3 className="font-black text-slate-800 text-sm mb-2">{app.title}</h3>
          ...
          <div className="text-center">
            <a
              href="/innovation"
              className="inline-flex items-center gap-2 bg-slate-800 text-white hover:bg-slate-800 font-bold text-sm px-7 py-3 rounded-xl transition"
            >
      ...
      <section className="py-16 bg-slate-50 border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-slate-800 mb-3">Staff Portal</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="bg-white rounded-2xl border border-slate-200 p-7">
              <h3 className="font-black text-slate-800 text-lg mb-4">What's Available in Your Portal</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex gap-3">
                    <div className="w-5 h-5 rounded-full bg-slate-800 text-white flex items-center justify-center shrink-0 text-[10px] font-black">{i + 1}</div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-7">
              <h3 className="font-black text-slate-800 text-lg mb-4">How to Login</h3>
              <div className="space-y-4">
                {[
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-slate-800 mb-3">Get in Touch</h2>
          ...
          <div className="grid md:grid-cols-3 divide-x divide-slate-200 border border-slate-200 rounded-2xl overflow-hidden max-w-3xl mx-auto">
            <a href="tel:0401343876" className="flex flex-col items-center text-center p-10 hover:bg-slate-50 transition">
              ...
              <h3 className="font-black text-slate-800 mb-1">Phone</h3>
            ...
            <a href="mailto:jeff@szjiesupportservices.com" className="flex flex-col items-center text-center p-10 hover:bg-slate-50 transition">
              ...
              <h3 className="font-black text-slate-800 mb-1">Email</h3>
            ...
            <div className="flex flex-col items-center text-center p-10">
              ...
              <h3 className="font-black text-slate-800 mb-1">Location</h3>
