import { Phone, Mail, MapPin, Heart, Users, Shield, Zap, ExternalLink, CheckCircle, ChevronDown, ChevronUp, Brain, Navigation, Laptop, Star, Building2, Globe } from "lucide-react";
...
const POLICIES = [
  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-slate-500 text-sm">As a registered NDIS provider, SZ-JIE Support Services and all associated staff are bound by the NDIS Code of Conduct to ensure integrity and safety in every interaction.</p>
